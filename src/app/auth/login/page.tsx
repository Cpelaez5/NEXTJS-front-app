...
import { useAuth } from '../../../lib/useAuth'; // Asegúrate de que esta ruta sea correcta
...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/dashboard/admin'); // Cambia '/pagina-deseada' por la ruta a la que quieras redirigir
    } catch (error) {
